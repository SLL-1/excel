...
public class DownExcelTemplateUtils {
    public static  void createExcelTemplate(String templateId){

        //文件路径
        try {
            URI path=new ClassPathResource("excelTemplate"+File.separator+templateId+".xml").getURI();
            ...
            response.setContentType("applayion/octet-stream");
            response.setHeader("Content-Disposition","attachment;filename=exportTemplate.xls");
